...
function forecastBlock(forcast) {
    ...
    day_One.style.display = "inline-block";
    day_Two.style.display = "inline-block";
    day_Three.style.display = "inline-block";
    day_Four.style.display = "inline-block";
    day_Five.style.display = "inline-block";
}
